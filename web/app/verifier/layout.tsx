...
const NAV = [
  { label: "Talent Pool", href: "/verifier" },
  { label: "Verify", href: "/verifier/verify" },
];
...
export default function VerifierLayout({ children }: { children: ReactNode }) {
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Talent Portal</h1>
        <p className="text-sm text-gray-500 mt-1">
          Employer &amp; Opportunity Provider — search verified youth profiles and request credential verification
        </p>
      </div>
